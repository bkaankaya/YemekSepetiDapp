...
router.post('/update-eth-price', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('ETH fiyat güncelleme hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
...
router.post('/update-token-price', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('Token fiyat güncelleme hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
...
router.post('/batch-update-prices', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('Toplu fiyat güncelleme hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
...
router.get('/eth-price', async (req, res) => {
    try {
        ...
        logger.error('ETH fiyat sorgu hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
...
router.get('/token-price/:tokenAddress', async (req, res) => {
    try {
        ...
        logger.error('Token fiyat sorgu hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
// Gas estimate
router.post('/estimate-gas', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('Gas estimate hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Oracle Error', error.message);
    }
});
// Oracle health check
router.get('/health', async (req, res) => {
    try {
        ...
        logger.error('Oracle health check hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'Health Check Error', error.message, 503);
    }
});
// Harici kaynaklardan fiyat güncelleme (manuel tetikleme)
router.post('/update-from-external', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('Harici fiyat güncelleme hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'External Update Error', error.message);
    }
});
// Fiyat güncelleme geçmişi
router.get('/price-history', authenticateApiKey, async (req, res) => {
    try {
        ...
        logger.error('Fiyat geçmişi sorgu hatası', { error: error.message, ip: req.ip });
        ResponseUtils.error(res, 'History Error', error.message);
    }
});
