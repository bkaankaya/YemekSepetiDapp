...
export class ResponseUtils {
    ...
    static badRequest(res, message, validationErrors) {
    ...
    static paginatedSuccess(res, data, pagination, message) {
    ...
    static fileDownload(res, filePath, fileName, contentType) {
